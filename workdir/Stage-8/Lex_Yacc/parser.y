...
ClassName     : ID                          { $$ = CInstall($1->name, NULL); current_class = $$; binding_addr += 8; }
              | ID EXTENDS ID               { $$ = CInstall($1->name, $3->name); current_class = $$; binding_addr += 8; }
              ;
...
Type        : INT                                       { type_variable = default_types->int_type; class_type = NULL; }
            | STR                                       { type_variable = default_types->str_type; class_type = NULL; }
            | ID                                        {
