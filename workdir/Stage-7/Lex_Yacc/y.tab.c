...
static const yytype_int16 yyrline[] =
{
      ...
      80,    81,    82,    83,    88,    91,    92,    95,    95,    99,
     100,   103,   108,   108,   112,   113,   116,   119,   120,   123,
     124,   127,   128,   129,   132,   133,   136,   137,   138,   141,
     142,   149,   150,   153,   154,   157,   160,   161,   164,   165,
     166,   167,   180,   181,   185,   185,   202,   202,   205,   205,
     210,   211,   212,   215,   216,   217,   218,   219,   222,   223,
     226,   227,   230,   234,   241,   243,   250,   255,   256,   257,
     272,   272,   281,   288,   292,   293,   298,   299,   300,   301,
     302,   303,   304,   305,   306,   307,   308,   309,   310,   311,
     312,   313,   314,   315,   316,   320,   325,   330,   337,   344,
     350,   355,   360,   367,   368,   373,   377,   381,   385,   389,
     392,   393,   396,   398,   400,   402,   404,   406,   408,   410,
     412,   414,   416,   418,   420,   422,   424,   426,   428,   430,
     432,   434,   436,   438,   440,   444,   445,   446,   447,   450,
     451,   455,   456,   457
};
#endif
...
#line 1848 "y.tab.c"
  ...
  case 27:
#line 119 "parser.y"
                                            { (yyval.class_node) = CInstall((yyvsp[0].AST_node)->name, NULL); current_class = (yyval.class_node); }
#line 1854 "y.tab.c"
    break;

  case 28:
#line 120 "parser.y"
                                            { (yyval.class_node) = CInstall((yyvsp[-2].AST_node)->name, (yyvsp[0].AST_node)->name); current_class = (yyval.class_node); }
#line 1860 "y.tab.c"
    break;
...
#line 1981 "y.tab.c"
  ...
  case 56:
#line 202 "parser.y"
                                                        { type_function = default_types->str_type; lst_binding = -3; code_gen_function_definition(outputFile, (yyvsp[-5].AST_node), current_class); add_param_list_to_lst((yyvsp[-3].param_node)); if(current_class) { insert_self(current_class);} lst_binding = 1; lst_display(); }
#line 1987 "y.tab.c"
    break;
...
#line 1993 "y.tab.c"
  ...
  case 58:
#line 205 "parser.y"
                                                         { type_function = tLookup((yyvsp[-6].AST_node)->name); lst_binding = -3; code_gen_function_definition(outputFile, (yyvsp[-5].AST_node), current_class); add_param_list_to_lst((yyvsp[-3].param_node)); if(current_class) { insert_self(current_class);} lst_binding = 1; lst_display(); }
#line 1999 "y.tab.c"
    break;
